...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1335: (x0,x1,x2,x3,x4,x5,x6,x7) => globalThis.Module_soloud._play(x0,x1,x2,x3,x4,x5,x6,x7),
      ...
      _1375: (x0,x1,x2) => globalThis.Module_soloud._fadeVolume(x0,x1,x2),
      _1379: (x0,x1) => globalThis.Module_soloud._scheduleStop(x0,x1),
      _1415: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1416: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1436: (x0,x1) => x0.getItem(x1),
      _1437: (x0,x1) => x0.removeItem(x1),
      _1438: (x0,x1,x2) => x0.setItem(x1,x2),
      _1439: Date.now,
      ...
      _1465: (o, p, r) => o.replaceAll(p, () => r),
      _1466: (o, p, r) => o.replace(p, () => r),
      _1467: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1468: s => s.toUpperCase(),
      _1469: s => s.trim(),
      _1470: s => s.trimLeft(),
      _1471: s => s.trimRight(),
      _1472: (string, times) => string.repeat(times),
      _1473: Function.prototype.call.bind(String.prototype.indexOf),
      _1474: (s, p, i) => s.lastIndexOf(p, i),
      _1475: (string, token) => string.split(token),
      _1476: Object.is,
      _1480: (o, t) => typeof o === t,
      ...
      _1644: (module,f) => finalizeWrapper(f, function(x0,x1) { return module.exports._1644(f,arguments.length,x0,x1) }),
      _1645: o => {
      ...
      _1690: (x0,x1) => new WebSocket(x0,x1),
      _1691: (x0,x1) => x0.send(x1),
      _1692: (x0,x1,x2) => x0.close(x1,x2),
      _1693: (x0,x1) => x0.close(x1),
      _1694: x0 => x0.close(),
      _1697: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1697(f,arguments.length,x0) }),
      _1701: () => globalThis.Module_soloud.HEAPU8.buffer,
      _1706: () => globalThis.Module_soloud.wasmWorker,
      _1709: () => new AbortController(),
      _1710: x0 => x0.abort(),
      _1711: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      ...
      _1715: (x0,x1) => x0.forEach(x1),
      _1716: x0 => x0.getReader(),
      _1717: x0 => x0.cancel(),
      _1718: x0 => x0.read(),
      _1719: x0 => new BroadcastChannel(x0),
      _1720: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1720(f,arguments.length,x0) }),
      _1721: (x0,x1) => x0.postMessage(x1),
      _1722: x0 => x0.close(),
      _1723: (x0,x1) => x0.key(x1),
      _1724: o => o instanceof Array,
      _1727: (a, l) => a.length = l,
      _1728: a => a.pop(),
      _1729: (a, i) => a.splice(i, 1),
      _1730: (a, s) => a.join(s),
      _1731: (a, s, e) => a.slice(s, e),
      _1733: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1734: a => a.length,
      ...
      _1746: o => o instanceof Uint8ClampedArray,
      _1747: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1748: o => o instanceof Uint16Array,
      _1749: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1750: o => o instanceof Int16Array,
      ...
      _1759: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1760: o => {
        if (o === null || o === undefined) return 0;
      ...
      _1762: (a, i) => a.push(i),
      _1763: (t, s) => t.set(s),
      _1764: l => new DataView(new ArrayBuffer(l)),
      ...
      _1792: Function.prototype.call.bind(Number.prototype.toString),
      _1793: Function.prototype.call.bind(BigInt.prototype.toString),
      _1794: Function.prototype.call.bind(Number.prototype.toString),
      _1795: (d, digits) => d.toFixed(digits),
      _1811: () => globalThis.console,
      _1850: (x0,x1) => x0.error(x1),
      ...
      _4193: x0 => x0.data,
      _4240: (x0,x1) => { x0.onmessage = x1 },
      _4298: (x0,x1) => { x0.onmessage = x1 },
      _4346: x0 => x0.length,
      _4563: x0 => x0.readyState,
      _4576: (x0,x1) => { x0.binaryType = x1 },
      _4579: x0 => x0.code,
      _4580: x0 => x0.reason,
      _6288: x0 => x0.signal,
      _8124: x0 => x0.value,
